...
> Generated: 2026-03-13T20:29:12.083Z
> Full documentation: https://github.com/ruvnet/ruflo
...
# Memory operations
npx ruflo@latest memory store --key "pattern" --value "data" --namespace patterns
npx ruflo@latest memory search --query "authentication"
...
# Spawn workers
npx ruflo@latest hive-mind spawn --count 5 --type worker

# Consensus
npx ruflo@latest hive-mind consensus --propose "task"
```
